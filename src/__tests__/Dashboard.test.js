...
describe("Given I am connected as an Admin", () => {
  ...
  describe("When I am on Dashboard page and I click on arrow", () => {
    test("Then, tickets list should be unfolding, and cards should appear", async () => {
      ...
      await waitFor(() => {
        expect(handleShowTickets1).toHaveBeenCalledTimes(1);
        console.log("Tickets 1 shown");
        expect(
      ...
      await waitFor(() => {
        expect(handleShowTickets2).toHaveBeenCalledTimes(1);
        console.log("Tickets 2 shown");
        expect(
      ...
      await waitFor(() => {
        expect(handleShowTickets3).toHaveBeenCalledTimes(1);
        console.log("Tickets 3 shown");
        expect(
  ...
  describe("When I am on Dashboard page and I click on edit icon of a card", () => {
    test("Then, right form should be filled", async () => {
      ...
      const handleEditClick = jest.fn((e) =>
        dashboard.handleShowTickets(e, bills, 1)
      );
      iconEdit.addEventListener("click", handleEditClick);
